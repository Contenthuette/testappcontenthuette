...
export const PRIVACY_SECTIONS: LegalSection[] = [
  ...
  },
  {
    heading: "5. Hosting",
    body: [
      "Wir nutzen den Dienst \u201eConvex\u201c der Convex, Inc., USA, zum Zwecke des Hostings, der Datenbank, Dateispeicherung und Echtzeit-Datensynchronisation auf Basis einer Verarbeitung in unserem Auftrag.",
  ...
  },
  {
    ...
    body: [
      ...
      "Wenn Sie Ihren Account l\u00f6schen, werden Ihre Daten gel\u00f6scht. \u00d6ffentlich ver\u00f6ffentlichte \u00c4u\u00dferungen k\u00f6nnen weiterhin f\u00fcr andere Leser sichtbar bleiben, Ihr Account ist jedoch nicht mehr abrufbar.",
